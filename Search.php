...
<body>
    ...
    <div ID="div_header_img">
        ...
        <Input type="text" ID="searchbox"><Input type="submit" Value=Search Mail ID="btn_search" name="Searchbox">            <a href="Logout.php">  <Input type="button" Value=Logout ID="btn_logout" ></a> 
...
$sql_select= "Select `Subject` ,`From` , `Body`,`Date` From `mail`  WHERE `To` = '$user' AND `Body` LIKE '%$search%' OR `Subject` LIKE '%$search%'";
